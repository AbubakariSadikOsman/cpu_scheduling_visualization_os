                    ...
                    <div className="w-full text-center">
                        <div className="bg-white">
                            ...
                            <div className="border border-gray-300 px-4 py-1">
                                <h2 className='text-[0.8rem] mb-3 font-medium text-center'>Average Completion Time</h2>
                                <p className='text-[1.2rem] mb-3 font-bold text-center'>
                                    {statiticsData.average_completion_time}<span className='text-[0.8rem] font-normal'>ms</span>
                                </p>
                            </div>

                            <div className="border border-gray-300 px-4 py-1">
                                <h2 className='text-[0.8rem] mb-3 font-medium text-center'>Average Waiting Time</h2>
                                <p className='text-[1.2rem] mb-3 font-bold text-center'>
                            ...
                            <div className="border border-gray-300 px-4 py-1">
                                <h2 className='text-[0.8rem] mb-3 font-medium text-center'>Average Turnaround Time</h2>
                                <p className='text-[1.2rem] mb-3 font-bold text-center'>
