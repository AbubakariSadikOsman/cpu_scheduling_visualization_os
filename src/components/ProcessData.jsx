...
const ProcessData = ({processId, arrivalTime, burstTime, priority, quantum, processes, setProcessID, setProcesses, setUpdatedProcesses, setArrivalTime, setBurstTime, setPriority, setQuantum, selectedAlgorithm, setExecuted, setStatisticsData}) => {
    let num_of_process = processes.length;
    const usesPriority = (selectedAlgorithm === 3 || selectedAlgorithm === 4 || selectedAlgorithm === 7);
  return (
        ...
        <form className='flex flex-col gap-[0.85rem] text-[0.9rem]'>
           ...
           <button 
                ...
                onClick={e => {
                    ...
                    setProcesses([...processes, { processId, arrivalTime, burstTime, priority, startTime: 0, completionTime: 0, remainingTime: burstTime }]);
                }}
            >
                Add Process
            </button>
            <button
                ...
                onClick={e => {
                    e.preventDefault();
                    executeSelectedAlgorithm(selectedAlgorithm, num_of_process, processes, setProcesses, setUpdatedProcesses, setExecuted, setStatisticsData);
                }}
            >
                Simulate
            </button>
